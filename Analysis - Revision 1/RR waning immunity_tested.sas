...
run;quit;
%let name = parms_VES_index_unvacc_tested ;
data &name. ;
	set parms ;
...
proc genmod data = data.analysis_final_2 ;
	...
	model
			...
			repeated subject=house_number / type=ind ;
run;quit;
%let name = parms_VES_index_vacc_tested ;
data &name. ;
	set parms ;
		EST_VE = (1-exp(estimate))*100 ;
		LCL_VE = (1-exp(UpperCL))*100 ;
...
proc genmod data = data.analysis_final_2 ;
	...
	model
			...
			repeated subject=house_number / type=ind ;
run;quit;
%let name = parms_VES_index_pool_tested ;
data &name. ;
	set parms ;
		EST_VE = (1-exp(estimate))*100 ;
		LCL_VE = (1-exp(UpperCL))*100 ;
...
proc genmod data = data.analysis_final_2 ;
	...
	model
			...
			repeated subject=house_number / type=ind ;
run;quit;
%let name = parms_VET_sec_unvacc_tested ;
data &name. ;
	set parms ;
		EST_VE = (1-exp(estimate))*100 ;
		LCL_VE = (1-exp(UpperCL))*100 ;
...
where Fully_vaccinated = 1 and ever_test =1;
	...
	model
			...
			repeated subject=house_number / type=ind ;
run;quit;
%let name = parms_VET_sec_vacc_tested ;
data &name. ;
	set parms ;
		EST_VE = (1-exp(estimate))*100 ;
		LCL_VE = (1-exp(UpperCL))*100 ;
...
where ever_test =1;
	...
	model
			...
			repeated subject=house_number / type=ind ;
run;quit;
%let name = parms_VET_sec_pool_tested ;
data &name. ;
	set parms ;
		EST_VE = (1-exp(estimate))*100 ;
		LCL_VE = (1-exp(UpperCL))*100 ;
